      ...
      <section className="relative h-[60vh] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 pb-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <span className={`px-3 py-1 rounded-full text-xs font-semibold ${getTypeLabel(vehicle.type)}`}>
              {vehicle.type}
            </span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              >
                ...
                <p className="text-surface-600 dark:text-surface-400">{vehicle.description}</p>
              </motion.div>
              ...
              >
                ...
                <div className="space-y-3 mb-6 text-sm">
                  <div className="flex justify-between">
                    ...
                    <span className="text-surface-700 dark:text-surface-300">{vehicle.type}</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-surface-500">Seating Capacity</span>
                    <span className="text-surface-700 dark:text-surface-300">{vehicle.seats} passengers</span>
                  </div>
                  <div className="flex justify-between">
