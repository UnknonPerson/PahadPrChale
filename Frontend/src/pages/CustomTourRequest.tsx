...
import { Search, Plus, MapPin, Calendar, Users, IndianRupee, Car, Hop as Home, UtensilsCrossed, Send, CircleAlert as AlertCircle, Check } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center p-4">
        ...
        >
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-6">
            We've received your custom tour request. Our team will review it and get back to you within 24-48 hours.
          </p>
          <div className="flex gap-3">
            ...
            <button
              onClick={() => navigate('/my-custom-tours')}
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-2">
            Let us create the perfect personalized travel experience for you
          </p>
        </div>
              ...
              <div>
                ...
                <div className="mt-4">
                  <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    Or specify your own destination
                  </label>
                  <input
                    type="text"
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                  {['flight', 'train', 'bus', 'car', 'mixed'].map((type) => (
                    <button
                      key={type}
                      onClick={() => setFormData({ ...formData, transportation: type })}
                      className={`p-3 rounded-xl border-2 text-center transition-all ${
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {['none', 'breakfast', 'half_board', 'full_board'].map((type) => (
                    <button
                      key={type}
                      onClick={() => setFormData({ ...formData, meals: type })}
                      className={`p-3 rounded-xl border-2 text-center transition-all ${
                        formData.meals === type
                          ? 'border-primary-500 bg-primary-50 dark:bg-primary-900/20'
                          : 'border-gray-200 dark:border-gray-700 hover:border-primary-200'
            ...
            >
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-4">
                ...
                <div className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
                  <p><span className="font-medium">Destinations:</span> {formData.destinations.join(', ') || formData.customDestination || 'Not specified'}</p>
                  ...
                  <p><span className="font-medium">Transport:</span> {formData.transportation}</p>
                </div>
              </div>
            </motion.div>
          )}
          ...
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            {step > 1 ? (
              <button
                ...
                className="px-6 py-2 rounded-xl bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600"
              >
                Previous
              </button>
            ) : (
            ...
            {step < 4 ? (
              <button
                onClick={() => setStep(step + 1)}
                className="flex items-center gap-2 px-6 py-2 rounded-xl bg-primary-500 text-white hover:bg-primary-600"
              >
                Next
              </button>
            ) : (
              <button
                ...
                className="flex items-center gap-2 px-6 py-2 rounded-xl bg-primary-500 text-white hover:bg-primary-600 disabled:opacity-50"
              >
                {isSubmitting ? (
